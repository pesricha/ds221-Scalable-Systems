...
if __name__ == "__main__":
    num_test_cases = 20
    num_records = 10  # Number of records in input_customer.csv
    num_products = 4  # Number of products in input_product.csv and input_price.csv
    num_new_hashtags_rows = 7  # Number of rows in input_newhashtags.csv
